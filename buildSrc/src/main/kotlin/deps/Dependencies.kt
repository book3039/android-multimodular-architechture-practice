...
object Dependencies {
    ...
    const val ANDROIDX_LIFECYCLE_RUNTIME_KTX = "androidx.lifecycle:lifecycle-runtime-ktx:${DependenciesVersion.LIFE_CYCLE_RUNTIME_KTX}"
    const val ANDROIDX_ACTIVITY_COMPOSE = "androidx.activity:activity-compose:${DependenciesVersion.ACTIVITY_COMPOSE}"
    const val ANDROIDX_COMPOSE_BOM = "androidx.compose:compose-bom:${DependenciesVersion.COMPOSE_BOM}"
